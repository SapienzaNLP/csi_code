...
if __name__ == '__main__':
    ...
    parser.add_argument("--starting_from_checkpoint", help="If set, the model continues training from a saved checkpoint, "
    ...
    parser.add_argument("--do_eval", help="If set, the model performs the evaluation step only. "
                                          "Otherwise, it will perform both training and evaluation.", action="store_true")
